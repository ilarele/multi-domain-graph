...
valid_gt_path = r'/data/multi-domain-graph-2/datasets/datasets_preproc_gt/replica/val/sem_seg'
valid_exp_path = r'/data/multi-domain-graph-2/datasets/datasets_preproc_exp/replica/val/sem_seg_hrnet'
valid_rgb_path = r'/data/multi-domain-graph-2/datasets/datasets_preproc_gt/replica/val/rgb'
